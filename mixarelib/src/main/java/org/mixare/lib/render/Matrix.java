...
public class Matrix implements Parcelable{
	...
	public Matrix prodAndReturn(Matrix n) {
		Matrix m = new Matrix();

		m.a1 = (a1 * n.a1) + (a2 * n.b1) + (a3 * n.c1);
		m.a2 = (a1 * n.a2) + (a2 * n.b2) + (a3 * n.c2);
		m.a3 = (a1 * n.a3) + (a2 * n.b3) + (a3 * n.c3);

		m.b1 = (b1 * n.a1) + (b2 * n.b1) + (b3 * n.c1);
		m.b2 = (b1 * n.a2) + (b2 * n.b2) + (b3 * n.c2);
		m.b3 = (b1 * n.a3) + (b2 * n.b3) + (b3 * n.c3);

		m.c1 = (c1 * n.a1) + (c2 * n.b1) + (c3 * n.c1);
		m.c2 = (c1 * n.a2) + (c2 * n.b2) + (c3 * n.c2);
		m.c3 = (c1 * n.a3) + (c2 * n.b3) + (c3 * n.c3);
